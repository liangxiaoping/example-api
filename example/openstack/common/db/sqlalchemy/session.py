...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(sql_connection="sqlite:///var/lib/example/sqlite.db",
                         sqlite_db="/var/lib/example/sqlite.db")
...
from example.openstack.common.db import exception
...
sql_opts = [
    cfg.StrOpt('sql_connection',
               default='mysql://example:example@127.0.0.1/example',
               help='The SQLAlchemy connection string used to connect to the '
                    'database',
               secret=True),
    cfg.StrOpt('sqlite_db',
               default='example.sqlite',
